...
internal sealed class SettingsForm : Form
{
    ...
    private void SaveAndClose()
    {
        ...
        if ((!settings.ToggleHotkey.IsEmpty && !settings.ToggleHotkey.IsValid) ||
            (!settings.OpenSettingsHotkey.IsEmpty && !settings.OpenSettingsHotkey.IsValid))
        {
            MessageBox.Show(
                this,
                "Shortcuts may be left empty. Letter and number keys must include Ctrl, Alt, Shift, or Win.",
                "Invalid shortcut",
        ...
        if (!settings.ToggleHotkey.IsEmpty &&
            settings.ToggleHotkey.Equals(settings.OpenSettingsHotkey))
        {
            MessageBox.Show(
                this,
